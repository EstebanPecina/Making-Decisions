...
if(temperature >= 80 && rain === true) {
  ...
  console.log("Wear a jacket and take a umbrella.");
} else if(temperature <=60 && rain ===true) {
  console.log("Its cold take a jacket.");
}
...
//  z = 5, 5 > 0
//     i = 5, 5 > 0, console.log(5)
//       i = 4, 4 > 0, console.log(4)
//         i = 3, 3> 0, console.log(3)
//           i = 2, 2 > 0, console.log(2)
//             i = 1, 1 > 0, console.log(1)
//               i = 0, 0 > 0, STOP
//   z = 4, 4 > 0
//     i = 4, 4 > 0, console.log(4)
//       etc...